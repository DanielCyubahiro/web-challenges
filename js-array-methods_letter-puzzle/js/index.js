...
const everyIdStartsWith0 = employees.every(
  employee => employee.id.startsWith("0"));
...
const employeeLouise33 = employees.find(
  (employee) => (employee.firstName === "Louise" || employee.lastName === "Louise") && employee.age === 33);
...
const ednaInvestment = employees.find(
  (employee) => employee.firstName === "Edna" && employee.profession ===
    "Investment Manager");
