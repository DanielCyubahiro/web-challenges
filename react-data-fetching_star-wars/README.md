...
- In your Code editor, switch to `pages/characters/[id].js`: it renders the `Card` component, but uses hard coded data.
...
- Switch to `./pages/characters/[id].js`:
...
- Rename the `/pages/characters/[id].js` file into `/pages/characters/[id].js`.
