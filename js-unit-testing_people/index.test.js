import { getFirstNames, getFullNames } from "./index.js";
...
test(
  "getFullNames() returns an array with full names as strings, e.g. \"Jane Doe\"",
  () => {
...
test(
  "getNameAndAge() returns an array of formatted strings like this: \"Skywalker (23)\"",
  () => {});

test("getPeopleByAge() returns an array of people of a certain age", () => {});

test(
  "getPeopleNamesOlderThan() returns an array of people full names older than a certain age, e.g. \"Luke Skywalker\"",
  () => {});
...
test(
  "isAnyoneOlderThan() returns true if any person is older than the given age",
  () => {});

test(
  "isAnyoneOlderThan() returns false if no person is older than the given age",
  () => {});
